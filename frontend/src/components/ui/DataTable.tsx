...
export function DataTable({ rows, onSort, tableFilter, isDark, onRowClick }: DataTableProps) {
                    ...
                    <tbody className="divide-y divide-warm-100 dark:divide-gray-700/50">
                        ...
                        {rows.map((row) => (
                            ...
                            <tr key={row.id}
                                ...
                                className="cursor-pointer hover:bg-warm-100/50 dark:hover:bg-gray-700/20 transition-all group">
